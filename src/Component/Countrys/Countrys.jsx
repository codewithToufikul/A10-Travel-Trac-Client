...
const Countrys = () => {
  ...
  useEffect(() => {
    fetch("https://travel-trac-server-e5royj9j5-toufikul-islams-projects-3e3e85a8.vercel.app/countrys")
      .then((res) => res.json())
      .then((data) => {
        setCountrys(data);
      });
    ...
    >
      <div className="max-w-[1440px] mx-auto">
        <div className="max-w-3xl mx-auto text-center space-y-4 p-10">
          <h1 className="text-blue-400 text-3xl md:text-4xl lg:text-5xl font-semibold">
            Chose Your{" "}
